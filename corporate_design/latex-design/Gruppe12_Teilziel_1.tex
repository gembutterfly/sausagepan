...
\begin{document}
	...
	\newcommand{\Eins}[1]{\color{orange}\underline{\textbf{{\Large#1}}}} %Überschrift 1. Ordnung
	\newcommand{\Zwei}[1]{\color{orange}\textit{\underline{\textbf{{\large#1}}}}} %Überschrift 2. Ordnung
